...
+ 示例
```javascript
{"recipients": "zhoushugang","postcode": "100000", addressDetail: "顺义校区504"}
```
+ 返回说明
参数|说明
--|--
...
+ 示例
```javascript
[{"id":2,"userId":2,"address":"","addressDetail":"顺义校区","isDelete":1,"recipients":"小明","postCode":"100000","mobile":null}]
```
